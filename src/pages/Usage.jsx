    ...
    return (
        <Detail {...props}>
            <article className="detail-item">
                <h4>JS</h4>
                <p>Place one of the following script near the end of your pages, right before the closing body tag, to enable them. jQuery must come first, then our JavaScript plugin.</p>
                <CodeWidget>
            ...
            <article className="detail-item">
                <h4>CSS</h4>
                <p>Copy-paste the stylesheet into your before all other stylesheets to load our CSS. You can use ready-made theme if you want.</p>
                <CodeWidget>
